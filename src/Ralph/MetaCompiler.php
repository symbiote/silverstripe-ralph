...
class MetaCompiler {
	public function postConstructCall() {
		singleton('Symbiote\\Ralph\\Ralph')->constructorStore($this);
	}
	...
	public function postFunctionCall() {
		...
		singleton('Symbiote\\Ralph\\Ralph')->profilerStore($this, __FUNCTION__, $timeDifference);
	}
	...
	public function process() {
		...
		foreach ($classesToInstrument as $originalClass => $data) {
			...
			$ralph->useCustomClass($originalClass, 'Symbiote\\Ralph\\Generated\\'.$classNameWithoutNamespace);
		}
	}
